...
export default function HPJoinScreen({ onCreate, onJoin, error }) {
    ...
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-display text-5xl font-bold text-brand-red">Hot Pants</h1>
          <p className="font-body text-gray-600 mt-2 font-semibold text-sm">
            One of you is lying. Figure out who.
          </p>
        </div>
