    ...
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-5xl font-black italic text-brand-red">Quiplash</h1>
            ...
            {['create', 'join'].map((t) => (
              <button
                ...
                className={`
                  ...
                  ${tab === t
                    ? 'text-brand-red bg-cream border-b-2 border-brand-red'
                    : 'text-gray-500 hover:text-gray-700 bg-cream-dark'}
                `}
              >
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Something your mom wouldn't pick"
                    maxLength={20}
                    className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 font-body font-semibold text-gray-800 placeholder-gray-300 focus:outline-none focus:border-brand-red transition-colors bg-cream"
                  />
                </div>
                <button
                  type="submit"
